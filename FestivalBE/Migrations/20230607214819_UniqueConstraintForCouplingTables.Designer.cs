...
namespace FestivalBE.Migrations
{
    ...
    [Migration("20230607214819_UniqueConstraintForCouplingTables")]
    partial class UniqueConstraintForCouplingTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FestivalBE.Models.ArtiestFavoriet", b =>
                {
                    ...
                    b.HasIndex("BezoekerId", "ArtiestId")
                        .IsUnique()
                        .HasFilter("[BezoekerId] IS NOT NULL AND [ArtiestId] IS NOT NULL");
